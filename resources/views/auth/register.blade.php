            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('actionRegister') }}"
                            method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="idProyek" name="idProyek"
                                    placeholder="Masukkan Id Proyek" required />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="idGrupUser" class="form-label">Grup User</label>
                            ...
                            <div class="mb-3">
                                <label for="idDepartment" class="form-label">Id Department</label>
                                <input type="text" class="form-control" id="idDepartment" name="idDepartment"
                                    placeholder="Masukkan Id Department" required />
                            </div>
                            <div class="mb-3">
                                <label for="formFile" class="form-label">Foto Pengguna</label>
                                <input type="file" class="form-control" id="fotoPengguna" name="image"
                                    placeholder="Masukkan Foto Pengguna" required />
                            </div>
