        ...
        <ul class="menu-sub">
            <li class="menu-item">
                <a href="{{ route('masterUser') }}" class="menu-link">
                    <div data-i18n="MasterUser">Master User</div>
                </a>
            </li>
            <li class="menu-item">
                <a href="{{ route('grupUser') }}" class="menu-link">
                    <div data-i18n="GroupUser">Group User</div>
                </a>
            </li>
            <li class="menu-item">
                <a href="" class="menu-link">
                    <div data-i18n="AksesMenu">Akses Menu</div>
                </a>
            </li>
            <li class="menu-item">
                <a href="" class="menu-link">
                    <div data-i18n="StandardReference">Standard Reference</div>
                </a>
            </li>
        </ul>
    </li>
