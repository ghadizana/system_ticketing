                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                                            ...
                                            <div class="button-wrapper">
                                                <a href="{{ route('editUser', $users->userId) }}"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input class="form-control" value="{{ $users->idKaryawan }}"
                                                    disabled />
                                            </div>
                                            <div class="mb-3 col-md-6">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input class="form-control" value="{{ $users->idProyek }}"
                                                    disabled />
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="lastName" class="form-label">Nama Grup user</label>
                                                <input class="form-control" value="{{ $users->idGrupUser }}"
                                                    disabled />
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="lastName" class="form-label">Nama Department</label>
                                                <input class="form-control" value="{{ $users->idDepartment }}"
                                                    disabled />
                                            </div>
                                            <div class="mb-3 col-md-6">
